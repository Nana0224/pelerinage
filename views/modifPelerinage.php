        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <form method="POST" action="../models/modifPelerinage.php" enctype="multipart/form-data">
                ...
                <!-- /.card-body -->
                  ...
                  <div class="card-footer col-12">
                    ...
                    <a href="../views/listePelerinage.php"><button type='button' class="btn btn-danger float-right">Annuler</button></a>
                  </div>
                </div>  
