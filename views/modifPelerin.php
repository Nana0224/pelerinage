        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <form method="POST" action="../models/modifPelerin.php">
                <div class="card-body row">
                  ...
                  <div class="form-group col-6">
                    ...
                    <select class="form-control" name="idPelerinage" required>
                      <option selected value="<?php echo $pelerin['id_pelerinage']; ?>">
                    <?php echo $pelerin['intitule_pel']; ?></option>
                    <?php
                      require_once('../controllers/database_connexion.php');
                  ...
                  <div class="form-group col-6">
                    ...
                    <select class="form-control" name="idDepense" required>
                      <option selected value="<?php echo $pelerin['id_depense']; ?>">
                    <?php echo $pelerin['intitule_dep']; ?></option>
                    <?php
                      require_once('../controllers/database_connexion.php');
                ...
                <!-- /.card-body -->
                  ...
                  <div class="card-footer col-12">
                    ...
                    <a href="../views/listePelerin.php"><button type='button' class="btn btn-danger float-right">Annuler</button></a>
                </div>
